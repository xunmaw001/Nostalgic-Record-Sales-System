    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="24" v-if="sessionTable !='changpian' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='changpian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品库存" prop="changpianKucunNumber">
                        <el-input v-model="changpianForm.changpianKucunNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='changpian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="购买获得积分" prop="changpianPrice">
                        <el-input v-model="changpianForm.changpianPrice"
                                  placeholder="购买获得积分" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="购买获得积分" prop="changpianPrice">
                            <el-input v-model="ruleForm.changpianPrice"
                                      placeholder="购买获得积分" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='changpian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="点击次数" prop="changpianClicknum">
                        <el-input v-model="changpianForm.changpianClicknum"
                                  placeholder="点击次数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="点击次数" prop="changpianClicknum">
                            <el-input v-model="ruleForm.changpianClicknum"
